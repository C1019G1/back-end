...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/login","/register","/product/*","/product/reg/*","/member/*","/user/*","/user/update/*","/login-history","/product/auc/*","/getid/*","/change-password","/reset-password","/cart").permitAll().and().
